    ...
    <section class="statistics-area-five pt-130" id="digital">
        <div class="container">
            <div class="row justify-content-center align-items-center text-justify">
                <div class="col-lg-7 privacy">
                    <div class="px-4 sm:px-6 lg:px-8">
                        <div class="relative mx-auto max-w-[37.5rem] pt-20 text-center pb-24">
                            <h1 class="text-4xl font-extrabold tracking-tight text-slate-900 sm:text-5xl">Privacy
                                policy</h1>
                            <p class="mt-4 text-base leading-7 text-slate-600">Last updated on August 19, 2023</p>
                        </div>
                    </div>
                    <div class="relative px-4 sm:px-6 lg:px-8 pb-100">
                        <div
                            ...
                            <p>At Maestloper Media, accessible from <a href=" https://www.maestlopermedia.com/">
                                    https://www.maestlopermedia.com/</a>, one of our
                            ...
                            <p>At Maestloper Media, accessible from <a
                                    href="https://www.maestlopermedia.com/">https://www.maestlopermedia.com/</a>, one of our
                                main
                                priorities is
                            ...
                            <p>This Privacy Policy applies only to our online activities and is valid for visitors
                                ...
                                Maestloper Media. This policy is not applicable to any information collected offline
                            ...
                            <ul>
                                ...
                                <li>5.Communicate with you, either directly or through one of our partners,
                                    including
                            ...
                            <p>Maestloper Media follows a standard procedure of using log files. These files
                                log
                                ...
                                and
                                time stamp, referring/exit pages, and possibly the number of clicks. These
                                are not
                                linked to any information that is personally identifiable. The purpose of
                                the
                            ...
                            <p>Like any other website, Maestloper Media uses "cookies". These cookies
                                are used to
                            ...
                            <p>Note that Maestloper Media has no access to or control over these
                                cookies that are
                                used by third-party advertisers.</p>

                            <h4>Third Party Privacy Policies</h4>

                            <p>Maestloper Media's Privacy Policy does not apply to other
                            ...
                            <p>We would like to make sure you are fully aware of all
                                of your data protection rights.
                                Every user is entitled to the following:</p>
                            <p>The right to access – You have the right to request
                            ...
                            <p>The right to rectification – You have the right to
                                ...
                                information you believe is inaccurate. You also have
                                the right to request that we
                                complete the information you believe is incomplete.
                            </p>
                            <p>The right to erasure – You have the right to request
                                that we erase your personal
                                data, under certain conditions.</p>
                            <p>The right to restrict processing – You have the right
                                to request that we restrict the
                            ...
                            <p>The right to data portability – You have the right to
                                request that we transfer the
                                data that we have collected to another organization,
                                or directly to you, under
                                certain conditions.</p>
                            <p>If you make a request, we have one month to respond
                            ...
                            <p>Another part of our priority is adding protection
                                for children while using the
                                internet. We encourage parents and guardians to
                                observe, participate in, and/or
                                monitor and guide their online activity.</p>

                            <p>Maestloper Media does not knowingly collect any
                                Personal Identifiable Information
                                from children under the age of 13. If you think
                                that your child provided this kind
                                of information on our website, we strongly
                                encourage you to contact us immediately
                                and we will do our best efforts to promptly
                                remove such information from our
                                records.</p>

                            <h4>Changes to This Privacy Policy</h4>

                            <p>We may update our Privacy Policy from time to
                                time. Thus, we advise you to review
                                ...
                                changes are effective immediately, after
